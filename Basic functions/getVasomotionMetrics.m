...
%   shared by getVasomotion (LSCI per-segment and per-pixel paths) and
...
%             getVasomotion for the full description).  s.nPeakProm is the findpeaks
...
%   Lifted verbatim from getVasomotion.  Builds the analytic-Morlet cwtfilterbank
