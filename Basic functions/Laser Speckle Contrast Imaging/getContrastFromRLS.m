...
%------------- BEGIN CODE --------------
function [dataLSCI,time,timeStamp,trustMatrix,settings]=getContrastFromRLS(rlsFileName,contrastType,contrastKernel,rawBatchSize,procType,decimation,selectROI)
