%myographWorkbench  Unified GUI for myograph diameter, vasomotion & propagation
%
%   myographWorkbench opens one programmatic uifigure app that replaces the
...
%   getMyographPropagation, processMyographFile, loadMyographResults,
...
%
%   h = myographWorkbench('Visible','off') creates the app without showing it and
...
%
%   DEPENDS ON  the Myograph/ headless functions above; base MATLAB + uifigure
...
function h = myographWorkbench(varargin)
...
delete(findall(groot,'Type','figure','Tag','myographWorkbench'));
...
fig=uifigure('Name','Myograph workbench','Position',[60 60 1400 860],'Visible',vis,'Tag','myographWorkbench');
app.fig=fig;
...
for ii=1:numel(idxs)
    ...
    if strcmp(stage,'diameter')
        ...
        out=processMyographFile(s,q.path);
    else
...
%% ===================== small helpers =============================== %%
% ---- Explore: sectioned control-column builders (ported from explore_results.m) ----
...
% ---- Explore: group-comparison math (ported from explore_results.m) ----
