...
%   fields name/time/idxL/idxR/diameter/mask), and cuts it into the time windows
%   ivT = [start end; ...] (seconds) with the matching NAMES.  The result is a
%   struct array in exactly the same format as getMyographDiameter would
%   return for predefined intervals - no re-detection is performed, the already
%   measured diameter is simply sliced by time.
%
