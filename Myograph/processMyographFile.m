%processMyographFile  Headless end-to-end processing of one myograph video
%
%   out = processMyographFile(s,fName) runs the whole analysis for a single
...
%   getMyographVasomotion, getMyographPropagation (all in Myograph/).
%
...
function out = processMyographFile(s,fName)
