...
%     core LSCI library utilities.  Consumes the output of getSegmentation,
%     getPulsatility and setVesselTypes.
%
% See also: setVesselTypes, getPulsatility, getSegmentation, getVasomotion
%
