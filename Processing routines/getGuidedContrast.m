%getGuidedContrast - Per-segment spatial contrast at full temporal resolution.
%
...
%   only available at the decimated frame rate.  getGuidedContrast streams the
...
% See also: getGuidedIntensity, getSegmentation, getContrast, getPointerRLS
%
