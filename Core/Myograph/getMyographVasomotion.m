...
%   vasomotion analysis as runVasomotion, but on in-memory myograph data and
...
%
%   The parameters are the SAME as runVasomotion (vFR, cFR, wFR, wVPO,
...
%          runVasomotion RESULTS.vasomotion.<sig> sub-tree, with the segment
...
%
%   DEPENDS ON
%     Core/Vasomotion/getVasomotionMetrics (shared wavelet vasomotion core; the
...
% ---- parameter defaults (same names as runVasomotion) ----
