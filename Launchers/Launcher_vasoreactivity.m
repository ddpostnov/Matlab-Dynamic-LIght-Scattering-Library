...
%SET FILE NAMES HERE
fNames=getFileNamesList(rootFolder,'*_t_K_r.mat','[A-Z]+\d+');
...
%SET FILE NAMES HERE
fNames=getFileNamesList(rootFolder,'*_t_BFI_r.mat'); %if structured file names were used then the getFileNamesList function can be used to populate them correctly. Otherwise you can generate fNames list manually.
...
%SET FILE NAMES HERE
fNames=getFileNamesList(rootFolder,'*_t_BFI_r.mat','[A-Z]+\d+');
