%runContrast  Core pipeline for converting *.rls recordings to speckle contrast
%
%   runContrast(s,fNames) reads each laser-speckle acquisition file (*.rls)
...
%     runContrast(p, fullfile({D.folder}',{D.name}'));
%
%   DEPENDS ON
